"""
Wordle game functions for validating guesses, checking patterns, and scoring.
"""
...
def is_valid_word(word, word_list):
    ...
    Examples
    --------
    >>> word_list = ["crane", "apple", "hello"]
    >>> is_valid_word("crane", word_list)
    True
    >>> is_valid_word("CRANE", word_list)
    True
    >>> is_valid_word("zzzzz", word_list)
    False
    """
